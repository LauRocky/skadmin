...
import com.dxj.common.util.ObjectUtil;
import com.dxj.common.util.ThreadPoolUtil;
...
public class SystemLogAspect {
    ...
    @Pointcut("@annotation(com.dxj.log.annotation.SystemLog)")
    ...
    private static class SaveSystemLogThread implements Runnable {
        ...
        SaveSystemLogThread(SystemLog systemLog, SystemLogService logService) {
            this.log = systemLog;
     ...
     * @throws Exception
     */
    private static Map<String, Object> getControllerMethodInfo(JoinPoint joinPoint) throws Exception {
        ...
        for (Method method : methods) {
            ...
            description = method.getAnnotation(com.dxj.log.annotation.SystemLog.class).description();
            type = method.getAnnotation(com.dxj.log.annotation.SystemLog.class).type().ordinal();
